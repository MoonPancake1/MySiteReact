...
- vC.Main **v.0.1.0.6**:
После отправки оценки, информация о
проекте обновляется

- vC.Main **v.0.1.0.5**:
Фикс отправки не той оценки, которую
выбрал пользователь, удалены некоторые
стикеры с главной страницы

- vC.Main **v.0.1.0.4**:
Открыт доступ к авторизации через vC.ID

- vC.Main **v.0.1.0.3**:
Фикс проблемы с подгрузкой комментариев
